...
\address{\href{mailto:anandkore1@gmail.com}{anandkore1@gmail.com} \\ \href{https://www.linkedin.com/in/anandkore101/}{LinkedIn} \\ \href{https://github.com/TheOneOh1}{GitHub}} \\ \href{https://theoneoh1.github.io/}{Portfolio}}
...
Infrastructure as Code & Terraform, Ansible, Bash, Python, YAML \\
Cloud Platforms & AWS (EC2, VPC, Lambda, IAM, S3, CloudWatch) \\
Observability \& Monitoring & Prometheus, Grafana, Loki, New Relic \\
Security \& Code Quality & SonarQube, Snyk, VAPT \\
OS \& Version Control & Linux (RHEL, Debian, Ubuntu), Git, Nginx \\
\end{tabular}\\
\end{rSection}
