...
Open `data/content.yaml` and replace the existing placeholder data with your own.
...
**Important Notes:**
- Your resume source lives in `resume/Anand_Kore_Resume.tex`. Edit it and push - the CI pipeline compiles the PDF automatically to `assets/docs/`.
